    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
        <ul
          ...
          <li>
            <RouterLink to="/" activeClass="text-white md:text-blue-700 md:dark:text-blue-500"
          ...
          <li>
            <RouterLink to="/sop" activeClass="text-white md:text-blue-700 md:dark:text-blue-500"
              class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              SOP
            </RouterLink>
          </li>
          ...
          <li>
            <RouterLink to="/faq" activeClass="text-white md:text-blue-700 md:dark:text-blue-500"
              class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              FAQ
            </RouterLink>
          </li>
          ...
          <li>
            <RouterLink to="/assignment" activeClass="text-white md:text-blue-700 md:dark:text-blue-500"
              class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
              Penugasan
            </RouterLink>
          </li>
