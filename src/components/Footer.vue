<template>
    ...
    <footer class="bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased print:hidden">
        <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
            &copy; 2023-2025 <a href="https://si.fti.unand.ac.id/" class="hover:underline" target="_blank">Departemen Sistem Informasi Universitas Andalas</a>.
        </p>
        <div class="flex justify-center items-center space-x-1">
            ...
            <a href="https://github.com/kemalhiero/pengelolaan-sop-frontend" data-tooltip-target="tooltip-github" class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
