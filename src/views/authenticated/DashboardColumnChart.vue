...
onMounted(() => {
    ...
    if (document.getElementById("app-column-chart") && typeof ApexCharts !== 'undefined') {
        const chart = new ApexCharts(document.getElementById("app-column-chart"), options);
        chart.render();
    }
...
<template>
    <div class="container mx-auto px-4 my-8 max-w-lg w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
