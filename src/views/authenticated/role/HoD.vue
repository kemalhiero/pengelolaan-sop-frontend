...
const submitHod = async () => {
    try {
        ...
        showChangeModal.value = false; // Tutup modal setelah berhasil
    } catch (error) {
...
watch(showChangeModal, (newValue) => {
    if (!newValue) {
...
<template>
    ...
    <div class="container mx-auto p-10 lg:px-16 lg:col-span-2">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Ketua Departemen saat ini:</h2>
    ...
    <div v-show="showChangeModal" class="fixed inset-0 z-50 flex items-center justify-center w-full h-full">
        <div class="fixed inset-0 bg-gray-800 bg-opacity-30" @click="showChangeModal = false"></div>
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div v-show="changeHodStep == 2" class="relative bg-white rounded-lg shadow">
                <button type="button" @click="showChangeModal = false"
