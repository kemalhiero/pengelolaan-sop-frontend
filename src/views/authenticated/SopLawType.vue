...
const data = [
    { tipe: 'UUD 1945', deskripsi: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor optio nesciunt sequi?', jumlah: 0 },
    { tipe: 'Undang-Undang', deskripsi: 'mama loren', jumlah: 3 },
    { tipe: 'Permenristekdikti', deskripsi: 'sekarang jadi mendikdasmen', jumlah: 4 },
    { tipe: 'Peraturan Rektor', deskripsi: 'rektor unand', jumlah: 2 },
]
