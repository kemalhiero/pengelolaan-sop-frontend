...
const submitData = async () => {
    try {
        ...
        isSucces.value = 'Gagal mengirim data.';
    }
};

// ---------------------------------
const showModalDelete = ref(false); // State untuk menampilkan modal

const openDeleteModal = () => {
    showModalDelete.value = true;
    initModals(); // Re-initiate modals setiap kali modal dibuka
};
...
<template>
    <main class="p-4 md:ml-64 h-auto pt-20">
        ...
        <SuccessToast v-if="isSucces == 'yes'" teks="Data Berhasil Ditambahkan!" />
        <DangerToast v-else-if="isSucces == 'no'" teks="Data Gagal Dihapus" />
                        ...
                        <tr v-for="(item, index) in data" :key="index" class="bg-white border-b">
                            ...
                            <td class="px-6 py-4 flex">
                                ...
                                <div v-if="showModalDelete"
                                    ...
                                    <!-- Overlay gelap -->
                                    <div class="fixed inset-0 bg-gray-800 bg-opacity-10"></div>
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Anda yakin ingin menghapus data ini? index{{ index }}</h3>
