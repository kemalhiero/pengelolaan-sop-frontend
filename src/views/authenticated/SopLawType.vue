                            ...
                            <form class="p-4 md:p-5">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        <!-- <label for="law-num" class="block mb-2 text-sm font-medium text-gray-900">Jenis peraturan</label> -->
                                        <input type="text" name="law-num" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Mis. Peraturan Presiden" required>
                                    </div>
                                </div>
