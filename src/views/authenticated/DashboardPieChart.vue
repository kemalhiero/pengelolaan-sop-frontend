...
onMounted(() => {
    if (document.getElementById("app-pie-chart") && typeof ApexCharts !== 'undefined') {
        const chart = new ApexCharts(document.getElementById("app-pie-chart"), getChartOptions());
        chart.render();
    }
})
...
<template>
    ...
    <div class="mx-auto px-4 my-8 max-w-lg w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
        ...
        <!-- Line Chart -->
        <div class="py-6" id="app-pie-chart"></div>
