...
const data = [
    { tipe: 'Peraturan Pemerintah', nomor: 95, tahun: 2021, pembahasan: 'Perguruan Tinggi Negeri Badan Hukum Universitas Andalas' },
    { tipe: 'Peraturan Rektor Universitas Andalas', nomor: 8, tahun: 2022, pembahasan: 'Organisasi dan Tata Kerja Organ Pengelola Universitas Andalas' },
    { tipe: 'Permenristekdikti', nomor: 53, tahun: 2016, pembahasan: 'Tata Cara Pembentukan Peraturan Perundang-Undangan di Kementerian Riset, Teknologi, dan Pendidikan Tinggi' },
]
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        ...
                                        <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                            ...
                                            <option value="uud">Undang-Undang Dasar 1945</option>
                                            <option value="uu">Undang-Undang</option>
                                            <option value="pp">Peraturan Pemerintah</option>
                                            <option value="pm">Peraturan Mentri</option>
                                            <option value="prua">Peraturan Rektor Universitas Andalas</option>
                                        </select>
                                    </div>
