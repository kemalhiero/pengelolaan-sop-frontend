...
<template>
  <TableSkeleton v-if="isLoading" :columns="3" :rows="10" class="mx-20 my-14" />
                ...
                <div class="p-4 md:p-5 space-y-4 max-h-[620px] overflow-y-auto">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <select id="org" required v-model="sopData.is_active" :disabled="isUpdateDisabled && sopData.version.length == 1"
