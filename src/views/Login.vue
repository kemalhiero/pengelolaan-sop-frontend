                    ...
                    <form class="space-y-4 md:space-y-6" action="/app">
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="nama@fti.unand.ac.id" required>
                        </div>
                        <div>
                            <label for="password"
                                class="block mb-2 text-sm font-medium text-gray-900">Sandi</label>
                        ...
                        Belum punya akun? <a href="#" class="font-medium text-primary-600 hover:underline>Register</a>
                    </p> -->
                    </form>
                </div>
            </div>
